...
template PickCard() {
    ...
    // we hash this in segments instead of hash(number, suit, password) for the purposes of the next question
    ...
    // verify selected card is the same by comparing its hash with computed hash
